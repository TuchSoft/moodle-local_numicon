...
This Moodle plugin, local_numicon, transforms numbers at the beginning of section and activity titles into number icons (Numicon). The number *must* be at the beginning of the title and followed by a dot (e.g., "1.").
...
* **Icon:** Choose square or cicle icon
